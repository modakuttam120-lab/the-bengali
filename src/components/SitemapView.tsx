...
const POLICIES = [
  ...
  },
  {
    ...
    content: {
      bn: "দ্য বেঙ্গলি পিডিয়া ব্যবহার করার মাধ্যমে, আপনি তথ্যপূর্ণ, গবেষণা-ভিত্তিক এবং ব্যক্তিগত উদ্দেশ্যে আমাদের পরিষেবা ব্যবহার করতে সম্মত হন। স্পষ্ট সম্পাদকীয় সম্মতি ছাড়া বিষয়বস্তু অনুলিপি, স্বয়ংক্রিয় ক্রলিং বা ডেটাবেস কাঠামোর রিভার্স ইঞ্জিনিয়ারিং মেধা সম্পত্তি আইনের অধীনে কঠোরভাবে নিষিদ্ধ।"
    }
  }
];
